...
import type { JSX } from '@canonical/vanilla-web-components';



export const CookiePolicy = /*@__PURE__*/createReactComponent<JSX.CookiePolicy, HTMLCookiePolicyElement>('cookie-policy');
